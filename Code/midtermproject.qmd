...
summary(data_w)
```
In the data, swc stands for Soil Water Content, st stands for Soil temperature, 1-6 being the different days of measurement, dar being Days After Rain, date is the date of measurement. 
...
## Conclusion 
We hypothesize that, soil respiration increases in fertilized and tilled plots. Additionally, we believe that plots under these treatments will have a higher respiration following precipation as compared to the control plots. 
...
2. 
2. Pinheiro J, Bates D, R Core Team (2023). nlme: Linear and Nonlinear Mixed Effects Models. R package version 3.1-164, https://CRAN.R-project.org/package=nlme.
